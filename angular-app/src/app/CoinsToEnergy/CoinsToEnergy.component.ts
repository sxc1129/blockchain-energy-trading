...
import { CoinsToEnergyService } from './CoinsToEnergy.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-coinstoenergy',
  templateUrl: './CoinsToEnergy.component.html',
  styleUrls: ['./CoinsToEnergy.component.css'],
  providers: [CoinsToEnergyService]
})
export class CoinsToEnergyComponent implements OnInit {
  ...
  constructor(private serviceCoinsToEnergy: CoinsToEnergyService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceCoinsToEnergy.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceCoinsToEnergy.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceCoinsToEnergy.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceCoinsToEnergy.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceCoinsToEnergy.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
