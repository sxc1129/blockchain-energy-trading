...
/**
 * Coins to Consumption transaction
 * @param {org.blockchain.energy.trading.CoinsToConsumption} UpdateValues 
 * @transaction
 */
function CoinsToConsumption(UpdateValues) {
    ...
    UpdateValues.consumptionInc.value = UpdateValues.consumptionInc.value + UpdateValues.energyValue;
    UpdateValues.energyDec.value = UpdateValues.energyDec.value - UpdateValues.energyValue;
                
    //get asset registry for Coins, Consumption and Energy, and update on the ledger
...
function EnergyToConsumption(UpdateValues) {
    ...
    return  getAssetRegistry('org.blockchain.energy.trading.Consumption')
        ...
        .then(function (){
            //generate energy usage event
            var factory = getFactory();
            var EnergyUsageEvent = factory.newEvent('org.blockchain.energy.trading', 'EnergyUsageEvent');
            EnergyUsageEvent.energyValue = UpdateValues.energyValue;
            emit(EnergyUsageEvent);
                })
}